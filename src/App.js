...
function App() {
  ...
  const [claim, set_claim] = useState(0);
  ...
  return (
    <>
      <Web3ReactProvider getLibrary={getLibrary}>
        <Router>
          <div>
            <Header set_con_wallet={set_con_wallet} claim={claim}/>
              ...
              <div id="body-container" className="body-container" style={{ width: bodywidth }}>
                ...
                <Switch>
                  ...
                  <Route exact path="/reserve">
                    <Reserve flag_con_wallet={flag_con_wallet} set_claim={set_claim}/>
                  </Route>
                  <Route exact path="/claim">
                    <Claim flag_con_wallet={flag_con_wallet} claim={claim} set_claim={set_claim}/>
                  </Route>
                </Switch>
                {/* <Footer /> */}
              </div>
